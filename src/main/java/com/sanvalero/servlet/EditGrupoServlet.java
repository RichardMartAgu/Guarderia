...
public class EditGrupoServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("esto es la letra"+request.getParameter("Letra_grupo"));
        String nombre_grupo = request.getParameter("nombre_grupo");
        System.out.println("esto es el nombre"+nombre_grupo);
        String dni_profesor = request.getParameter("dni_profesor");
        System.out.println("esto es dni"+dni_profesor);
