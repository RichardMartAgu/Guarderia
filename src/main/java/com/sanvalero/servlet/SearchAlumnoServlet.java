    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if(Objects.equals(id_alumno, "") || Objects.equals(letra_grupo, "")){
                ...
                Class.forName("com.mysql.cj.jdbc.Driver");
                Database.connect();
                listaAlumnos = Database.jdbi.withExtension(AlumnoDAO.class, dao -> {
            ...
            for (Alumno alumno : listaAlumnos) {
                ...
                out.println("<td>");
                out.println("<a href=\"./view-detail-alumno.jsp?Id_alumno=" + alumno.getId_alumno() + "\" class=\"btn btn-primary btn-sm\">Editar</a>");
                out.println("<a href=\"./edit-alumno.jsp=?Id_alumno=" + alumno.getId_alumno() + "\" class=\"btn btn-danger btn-sm\">Borrar</a>");
                out.println("</td>");
                out.println("</tr>");
            }
