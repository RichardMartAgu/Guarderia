...
<div class="d-flex justify-content-center">
  <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Editar Imagen Grupo</li>
    </ol>
  </nav>
</div>
<%
...
<div class="container px-5">
    <h3 class="display-4 fw-normal text-center">Editar Foto Grupo</h3>
    <br/> <br/>
...
<div class="col-md-6">
       ...
       <div>
               <input type="hidden" class="form-control"  name="Letra_grupo" value= "<%= letraGrupo %>" >
          </div>
