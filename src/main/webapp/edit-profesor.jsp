...
<div class="d-flex justify-content-center">
  <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
    ...
    Profesor profesor = Database.jdbi.withExtension(ProfesorDAO.class, dao -> dao.getProfesor(DniProfesor));
   %>
<div class="container px-5">
    <h3 class="display-4 fw-normal text-center">Editar Profesor</h3>
    <br/> <br/>
    <form class="row g-3 needs-validation">
     <div class="col-md-6">
            <label for="nombre" class="form-label">Nombre</label>
            <input type="text" class="form-control" id="nombre_profesor" name="nombre_profesor"value= "<%= profesor.getNombre_profesor() %>" required>
      ...
      <div class="col-md-6">
        ...
        <input type="email" class="form-control" id="email"name="email" value= "<%= profesor.getEmail() %>"required>
        <div class="invalid-feedback">
      ...
      <div class="col-md-6">
        ...
        <input type="tel" class="form-control" id="telefono"name="telefono"value= "<%= profesor.getTelefono() %>"required>
        <div class="invalid-feedback">
      ...
      <div class="col-12">
        ...
        <input type="text" class="form-control" id="direccion" name="direccion" value= "<%= profesor.getDireccion() %>"required>
        <div class="invalid-feedback">
              Por favor ingrese la dirección.
         </div>
      </div>
      <div>
          <input type="hidden" class="form-control"  name="Dni_profesor" value= "<%= profesor.getDni_profesor() %>" >
     </div>
     ...
     $(document).ready(function() {
         $('form.needs-validation').submit(function(event) {
             ...
             if ($(this)[0].checkValidity() === false) {
                 ...
                 $.post("edit-profesor", formValue, function(data) {
                     $("#result").html(data);
